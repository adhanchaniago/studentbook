						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form action="cek_backend.php" class="mt" method="post" enctype="multipart/form-data">
									...
									<input type="text" name="EmailAdmin" placeholder="Username" class="form-control mb">

									<label for="" class="text-uppercase text-sm">Password</label>
									<input type="password" name="PasswordAdmin" placeholder="Password" class="form-control mb">
