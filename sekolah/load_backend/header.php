...
<head>
	...
	<meta name="theme-color" content="#3e454c">
	 ...
	 <title>Studentbook Zona Sekolah</title>
...
<body>
	<div class="brand clearfix">
		<a href="main_content.php" class="logo"><font size="2.5" color="white"><strong>Zona Area Sekolah</font></strong>
			<!-- <img src="../media/studentbook.jpg" height="200" width="400" class="img-responsive" alt=""> --></a>
		<span class="menu-btn"><i class="fa fa-bars"></i></span>
		<ul class="ts-profile-nav">
			<li class="ts-account">
				<a><img src="../upload/<?php echo strtoupper($_SESSION['FotoLogo']); ?>" alt="<?php echo strtoupper($_SESSION['FotoLogo']); ?>" height="20" width="30">  
					<?php $potongkan_namanya_bah = substr(strtoupper($_SESSION['NamaKepSek']),0,5); echo $potongkan_namanya_bah; ?>  <i class="fa fa-angle-down hidden-side"></i></a>
				<ul>
	...
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<ul class="ts-profile-nav">
					<li class="ts-account">
						<a><img src="../upload/<?php echo strtoupper($_SESSION['FotoLogo']); ?>" alt="<?php echo strtoupper($_SESSION['FotoLogo']); ?>" height="42" width="42"> <strong><?php echo strtoupper($_SESSION['NamaKepSek']); ?></strong> <i class="fa fa-angle-down hidden-side"></i></a>
						<ul>
							<li><a href="logout.php" onClick="return confirm('Apakah anda ingin keluar dari aplikasi ini?');">Logout</a></li>
						</ul>
					</li>
